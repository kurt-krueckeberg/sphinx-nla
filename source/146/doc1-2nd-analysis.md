...
# Definition (contextualized to Schaumburg-Lippe, late 18th c.) {#_definition_(contextualized_to_schaumburg_lippe,_late_18th_c_)}
...
- **Residence is derivative**, not independent (living *bei* someone else).
...
- **Eligible---but not entitled---to apply** for land allocation via the Rentkammer.

'''''

## Authoritative historical sources (with citations) {#_authoritative_historical_sources_(with_citations)}

## 1. Johann Christoph Adelung (1793--1801) {#_1_johann_christoph_adelung_(1793–1801)}
...
## 2. Deutsches Wörterbuch (Jacob & Wilhelm Grimm) {#_2_deutsches_wörterbuch_(jacob_&_wilhelm_grimm)}
...
## 3. Regional agrarian-social history (Northwest Germany) {#_3_regional_agrarian_social_history_(northwest_germany)}
...
## Reading your petition sentence in that legal sense {#_reading_your_petition_sentence_in_that_legal_sense}
...
## Bottom line (for your documentation / glossary) {#_bottom_line_(for_your_documentation_/_glossary)}
...
- Draft a **formal glossary entry** in English and German (with footnotes),

- Compare *Einlieger* precisely against *Brinksitzer*, *Häusling*, *Kötter* **in Schaumburg-Lippe specifically**, or

- Help you **standardize terminology** across your Antora site so the term is used consistently.
