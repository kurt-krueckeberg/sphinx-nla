...
# 1. Function and position within the case file {#_1_function_and_position_within_the_case_file}
...
## 2. Administrative metadata and filing context {#_2_administrative_metadata_and_filing_context}

## a. Rentkammer intake {#_a_rentkammer_intake}
...
## b. Marginal rescript and routing {#_b_marginal_rescript_and_routing}
...
## 3. Identity and legal status of the petitioner {#_3_identity_and_legal_status_of_the_petitioner}

## a. Social and legal position {#_a_social_and_legal_position}
...
## b. Intended status change {#_b_intended_status_change}
...
## 4. Description and prior status of the requested land {#_4_description_and_prior_status_of_the_requested_land}

## a. Origin and administrative status {#_a_origin_and_administrative_status}
...
## b. Physical condition of the site {#_b_physical_condition_of_the_site}
...
## 5. Occupational logic and site suitability {#_5_occupational_logic_and_site_suitability}
...
## 6. Legal formulation of the request {#_6_legal_formulation_of_the_request}
...
## 7. Dating, endorsements, and closing formula {#_7_dating,_endorsements,_and_closing_formula}
...
## 8. What this document definitively establishes {#_8_what_this_document_definitively_establishes}
...
## 9. What it does not yet establish {#_9_what_it_does_not_yet_establish}
...
## 10. Bottom-line interpretation (corrected) {#_10_bottom_line_interpretation_(corrected)}
...
## How to interpret *Einlieger*, *Neubauer*, *Colon* {#_how_to_interpret_einlieger,_neubauer,_colon}
...
## Sources, hierarchy, links, and proper use (Schaumburg-Lippe context) {#_sources,_hierarchy,_links,_and_proper_use_(schaumburg_lippe_context)}

The correct approach is **layered**, not single-source. Each source type answers a different historical question.

'''''

## **Layer 1 --- General legal-historical meaning (baseline control)** {#_layer_1_—_general_legal_historical_meaning_(baseline_control)}

### **Deutsches Rechtswörterbuch (DRW)** {#_deutsches_rechtswörterbuch_(drw)}
...
- **Einlieger** <https://drw.hadw-bw.de/drw-cgi/zeige?index=lemmata&term=einlieger>

- **Neubauer** <https://drw-www.adw.uni-heidelberg.de/drw-cgi/zeige?index=lemmata&term=neubauer>
...
## **Layer 2 --- Regional social & administrative function (interpretive context)** {#_layer_2_—_regional_social_&_administrative_function_(interpretive_context)}

### **Das Fürstentum Lippe im Zeitalter der Französischen Revolution 1770--1820 --- Jürgen Arndt (1992)** {#_das_fürstentum_lippe_im_zeitalter_der_französischen_revolution_1770–1820_—_jürgen_arndt_(1992)}

#### **Direct PDF (LWL digital edition, Part II):** {#_direct_pdf_(lwl_digital_edition,_part_ii):}
...
The relevant discussion is in the section on: \_*\_ Ländliche Sozialstruktur / Untere ländliche Schichten*\_\_
...
## **Layer 3 --- Schaumburg-Lippe--specific, primary-era authority** {#_layer_3_—_schaumburg_lippe–specific,_primary_era_authority}

I will skip this since J. Arndt uses this as his primary sources!

## **Layer 4 --- Your Rentkammer case files (authoritative local practice)** {#_layer_4_—_your_rentkammer_case_files_(authoritative_local_practice)}
...
## **Putting it all together (methodologically sound)** {#_putting_it_all_together_(methodologically_sound)}
...
## **Bottom-line synthesis (safe to quote/paraphrase)** {#_bottom_line_synthesis_(safe_to_quote/paraphrase)}
...
## **In one sentence** {#_in_one_sentence}
