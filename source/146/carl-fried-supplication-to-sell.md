...
## 1. Nature of the document {#_1_nature_of_the_document}
...
## 2. "Bezug im Bericht an das Amt Bückeburg" {#_2_bezug_im_bericht_an_das_amt_bückeburg}
...
## 3. NC vs. internal routing marks {#_3_nc_vs_internal_routing_marks}
...
## 4. Substantive content {#_4_substantive_content}
...
## 5. "Neubauer-Colonie" {#_5_neubauer_colonie}
...
## 6. Social and legal implications {#_6_social_and_legal_implications}
...
<!-- Malformed Antora Block: ::: {wrapper="1" link="self" title="Carl Friedrich Krückeberg's Supplication to Sell no. 18 Berenbusch"} -->
![](images/21-r.png)
:::
