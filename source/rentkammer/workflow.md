...
# 1. Main kinds of numbers {#_1_main_kinds_of_numbers}
...
## 2. Documents that received `Num:` `Pr:` {#_2_documents_that_received_num:_pr:}
...
## 3. Documents that do not have `Num:` `Pr:` {#_3_documents_that_do_not_have_num:_pr:}
...
## 4. Meaning of the `ad` `…` notations {#_4_meaning_of_the_ad_…_notations}
...
## 5. How a typical case moved {#_5_how_a_typical_case_moved}
...
## 6. Meaning of the main terms {#_6_meaning_of_the_main_terms}
...
## Terminology Clarification {#_terminology_clarification}
...
* - Term
  - Misleadingly Looks like
  - Actual meaning in the file
* - Concept (Conc.)
  - idea
