...
# The Acten-Designation / Designatio Actorum --- the case file's own "table of contents" {#_the_acten_designation_/_designatio_actorum_—_the_case_file’s_own_“table_of_contents”}
...
* - Number
  - Documents
* - 1.
  - Vorstellung des Col. Krückeberg No 10 in Berenbusch------Anb.
* - 2.
...
* - 〃
  - Cpt. KRes. an p Krückeberg
```

## Cross-Referencing the Contents List to Its Documents {#_cross_referencing_the_contents_list_to_its_documents}

For each number in column one of the contents list, the first document listed will have this number written in the upper right corner of the first page. This first document for **#2** in the able above is the [Bericht Amts Bückeburg](../#689/amt-decree.md) (Report of the Bückeburg Office); in the upper right corner of its first page, **2** is written:

image

:   689:example-entry-num-on-doc.jpg\[title=\"pr in Cam 11 OCt 1841 (2 visible in right corner),link=self\]

## Numbering Systems of the Rentkammer in Schaumburg-Lippe (Mid-19th Century) {#_numbering_systems_of_the_rentkammer_in_schaumburg_lippe_(mid_19th_century)}
...
## The "Nr pr. ####" Numbers --- Protocol / Register Numbers {#_the_“nr_pr_####”_numbers_—_protocol_/_register_numbers}
...
## Distinction Between the Two Systems {#_distinction_between_the_two_systems}
...
## Meaning of \"ad NC ####\" {#_meaning_of_\"ad_nc_####\"}
