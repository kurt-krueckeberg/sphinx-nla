# Narrative Overview {#_narrative_overview .narrow}
...
In the report, measurements were given in **Ruther (rod)** and **Fuß (feet)**. A **\"Ruther\"** is a measure of area --- a Quadratruthe (square rod). German officials in the 18^th^--19^th^ centuries often shortened Quadratruthe (square rods) simply to Ruthe when the meaning was clear from context, as the word "Flächengehalt" (surface area) indicates.
