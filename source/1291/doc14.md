...
# Petition Docket Page {#_petition_docket_page}

<!-- Malformed Antora Block: ::: {wrapper="1" link="self" width="65%"} -->
![](images/29-l.png)
```

## Transliteration and Translation of Outer Address Page {#_transliteration_and_translation_of_outer_address_page}

```
:widths: 50 50
:header-rows: 1

* - An Se. Durchlaucht, meinem gnädigsten Fürsten und Herrn  des Neubauers Brüggemann No 14 zu Nordholz  Unterthänigste Vorstellung und Bitte:  Ich um einen ausgewiesenen Platz gnädigst zu schenken
  - To His Serene Highness, my most gracious Prince and Lord,  [from] the Neubauer (settler) Brüggemann, No. 14 in Nordholz  Most humble statement and petition:  I humbly request that the allotted plot be most graciously granted to me.
```

## Document 14 {#_document_14}

## Image {#_image}

<!-- Malformed Antora Block: ::: {wrapper="1" link="self" title="Receipt" width="70%"} -->
![](images/27-l.png)
```

<!-- Malformed Antora Block: ::: {wrapper="1" link="self" width="70%"} -->
![](images/28-l.png)
```
