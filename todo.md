...
We will use a 'wide' or 'wide-page' class  for wider content.

## CSS dark mode issue

The dark mode colors in overrides.css don't work with the default font
colors--at when tables are used.
